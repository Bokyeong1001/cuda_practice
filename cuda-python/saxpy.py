...
print('kernel time elapsed:', kernel_end - kernel_start)
print('program time elapsed:', end - start)
#kernel time elapsed: 2.4080276489257812e-05
#program time elapsed: 0.21276402473449707